...
export default defineConfig({
  ...
  define: {
    'import.meta.env': {
      VITE_SUPABASE_URL: process.env.VITE_SUPABASE_URL || 'https://vfrxxfviaykafzbxpehw.supabase.co',
      VITE_SUPABASE_ANON_KEY: process.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZmcnh4ZnZpYXlrYWZ6YnhwZWh3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjcwMTc1NTQsImV4cCI6MjA4MjU5MzU1NH0.BE4miINNQTVCL20piFzAVZTqtHvuWCe58MpfQ_M8SU0',
      VITE_API_URL: process.env.VITE_API_URL || 'http://localhost:8000',
      VITE_APP_URL: process.env.VITE_APP_URL || 'https://9lmntsstudio.com'
    }
  },
  resolve: {
